...
class SmallSynthData(Dataset):
    ...
    def unnormalize(self, data):
        if self.no_norm:
            ...
            result = (data[:, :, :, :2] + 1) * (self.loc_max - self.loc_min) / 2. + self.loc_min
            return result
...
if __name__ == '__main__':
    ...
    for sim in range(num_sims):
        # Inicializa las posiciones y velocidades de las partículas (si es necesario)
        ...
        for time_step in range(args.num_time_steps):
            ...
            if np.linalg.norm(p3_loc - p1_loc) < 1:
                ...
                current_edge[0] = 1  # Indicador de interacción entre p1 y p3
            ...
            if np.linalg.norm(p3_loc - p2_loc) < 1:
                ...
                current_edge[3] = 1  # Indicador de interacción entre p2 y p3
            ...
            # Construye las características actuales
            p1_feat = p1_loc
            p2_feat = p2_loc
            p3_feat = p3_loc
